...
## Якщо немає Windows Pro

Sandbox недоступний на Windows Home. Альтернативи:
- **VirtualBox** — безкоштовна VM, потребує окремого ISO Windows
- **Any.run** — онлайн пісочниця для аналізу файлів (є free tier)
- **VirusTotal** — завантаж файл на перевірку 70+ антивірусами

## Безпека Sandbox

За замовчуванням спільний буфер обміну увімкнений — обережно з чутливими даними при копіюванні між основною системою і Sandbox.

Малваре теоретично може вийти за межі Sandbox через VM escape, але це вкрай рідко і вимагає складного zero-day. Для типового споживчого малваре Sandbox безпечний.
