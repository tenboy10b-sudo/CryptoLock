...
Принтер є в системі але не друкує — найпоширеніша проблема. Зазвичай причина в зависшій черзі друку або службі Print Spooler. (Для глибшого розбору падінь Spooler, прав доступу і чистки реєстру — [як виправити помилки Print Spooler](/vypravlennya-spuler-druku-windows).)
