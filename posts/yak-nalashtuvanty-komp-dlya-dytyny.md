...
Якщо не хочеш використовувати Microsoft Family Safety — є альтернатива через локальний акаунт і вбудовані інструменти Windows. (Якщо навпаки хочеш саме Family Safety — фільтрація сайтів, звіти про активність, обмеження часу через хмару: [батьківський контроль в Windows](/yak-nalashtuvaty-batkivskyy-kontrol-windows).)
