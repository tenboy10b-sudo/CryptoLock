...
## Захисник постійно блокує потрібний файл

Спочатку перевір файл на virustotal.com. Якщо підтверджено чистий — додай виключення для конкретного файлу, а не для цілої папки.
