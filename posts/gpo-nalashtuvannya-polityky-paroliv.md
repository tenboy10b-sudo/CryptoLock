...
description: "Налаштування політики паролів Windows: мінімальна довжина, складність, термін дії і Fine-Grained Password Policy в Active Directory через PowerShell. Локально через secpol і для домену через GPO."
...
Дуже суворі вимоги (занадто часта зміна, занадто складні вимоги) змушують користувачів записувати паролі на папірцях — це ще гірше для безпеки домашнього чи малого офісу. Золота середина для не-доменних середовищ: мінімум 10-12 символів, складність увімкнена, зміна раз на 90 днів.
