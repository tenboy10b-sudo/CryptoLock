...
description: "Robocopy — вбудований інструмент Windows для копіювання і синхронізації папок: основні параметри, дзеркальне копіювання, журналювання, порівняння з xcopy/copy і автоматизація через Task Scheduler."
...
| `/MOV` / `/MOVE` | Переміщення файлів (`/MOVE` — і файлів, і папок), видаляє оригінал |
