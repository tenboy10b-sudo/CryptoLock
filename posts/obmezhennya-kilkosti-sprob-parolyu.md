---
title: "Обмеження спроб пароля Windows через GPO і реєстр — захист за 3 хв"
date: "2026-04-08"
updated: "2026-05-29"
description: "Як виставити обмеження кількості спроб пароля в Windows 10 і 11 через GPO або реєстр. Захист від brute-force атак — покрокові команди і налаштування."
...
**Читай також:**
- [заборону запуску програм через GPO](/zaborona-zapusku-prohram-gpo)
- [автоматичне блокування екрана](/yak-nalashtuvanty-avtomatychne-blokuvannya-windows)
