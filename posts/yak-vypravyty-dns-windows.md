...
Для більшості користувачів — так. Швидші і надійніші ніж DNS провайдера. Cloudflare (1.1.1.1) — приватність. Google (8.8.8.8) — швидкість. Детальніше про вибір і зміну DNS-провайдера, включно з DNS over HTTPS: [Як налаштувати DNS в Windows вручну](/yak-zminyty-dns-windows)
