...
`Win + I` → **System** → **Multitasking** → check **Snap windows** is on → expand it → enable:
...
Download **Microsoft PowerToys** from [github.com/microsoft/PowerToys](https://github.com/microsoft/PowerToys) → enable **FancyZones** → launch FancyZones Editor → draw any layout you want.
