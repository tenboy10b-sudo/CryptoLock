...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // "Скинути пароль Windows" — 2 статті об'єднано в skydannya-parolya-windows-bez-dyska (з черги, повніша)
      ...
      { source: '/windows-storage-spaces-nalashtuvannya', destination: '/nalashtuvannya-storage-spaces-windows', permanent: true },
      ...
      // EN "Task Scheduler" cluster — 4 статті об'єднано у 2 (basic + advanced)
