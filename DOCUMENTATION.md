...
- [ ] З'ясувати причину білду, що впав, в Railway проєкті `remarkable-integrity` (сервіс `web`) через звичайний дашборд (без CLI)
- [ ] Якщо колись знадобиться CLI-доступ до Railway знову — перевірити чи є вхід через email/Google, не тільки GitHub
