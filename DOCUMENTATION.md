...
**PROBLEM:** у Google Search Console велика кількість URL має статуси «Crawled — currently not indexed» і «Discovered — currently not indexed». Останній зафіксований підсумок «проіндексовано» — 13.08.2026 (66 / 792 / 858). До будь-якого SEO-рішення треба було встановити, з чого фактично складається цей беклог: скільки в ньому реальних, поточних, індексованих сторінок, а скільки — застарілого/недієвого шуму (редіректи, історичні `/en/`-fallback, теги), і чи видно з цього діючу причину. Завдання було **лише на читання** й документування: жодних змін коду, SEO, sitemap, редіректів, robots, контенту, GSC чи експериментів.
...
**FOLLOW-UP:**
- **P1:** оцінити Crawl Priority Experiment 2026-10-08 на свіжих експортах Crawled + Discovered (TEST проти CONTROL); після цього дослідити 462 поточні індексовані URL беклогу; переглянути внутрішнє лінкування / контентну архітектуру, якщо TEST не випередить CONTROL.
