...
// Перевіряє чи стаття вже опублікована
...
// Тільки опубліковані slug → getStaticPaths генерує лише їх
// Незапубліковані статті просто НЕ існують як URL до своєї дати
export function getAllSlugs() {
  ...
  return fileNames
    ...
    .filter(isPublished)  // ← тільки опубліковані!
